...
const TEMP_THEMES = [
    ...
    { id: 'temp-03', name: '人像纪实', tags: ['PORTRAIT', 'DOCUMENTARY'], images: images.slice(10, 15) },
    { id: 'temp-04', name: '建筑几何', tags: ['ARCHITECTURE', 'GEOMETRY'], images: images.slice(15, 20) },
    { id: 'temp-05', name: '街头色彩', tags: ['STREET', 'COLOR'], images: images.slice(20, 25) },
    { id: 'temp-06', name: '山川湖海', tags: ['LANDSCAPE', 'TRAVEL'], images: images.slice(25, 30) },
    { id: 'temp-07', name: '静物光影', tags: ['STILL LIFE', 'LIGHT'], images: [...images.slice(30), ...images.slice(0, 2)] },
